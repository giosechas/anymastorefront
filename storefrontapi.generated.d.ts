...
> & {
  ...
  > & {
    ...
    product: Pick<
      ...
      'handle' | 'title' | 'id' | 'vendor' | 'productType' | 'tags'
    >;
...
export type PackProductsQueryVariables = StorefrontAPI.Exact<{
  searchQuery: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type PackProductsQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
export type AnimaSiblingsQueryVariables = StorefrontAPI.Exact<{
  searchQuery: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type AnimaSiblingsQuery = {
  products: {
    nodes: Array<Pick<StorefrontAPI.Product, 'title' | 'handle' | 'tags'>>;
  };
};

export type AnimaVariantsQueryVariables = StorefrontAPI.Exact<{
  searchQuery: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type AnimaVariantsQuery = {
  products: {
    nodes: Array<
...
export type FallbackRecommendationsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FallbackRecommendationsQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
export type WishlistRecommendationsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type WishlistRecommendationsQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query PackProducts($searchQuery: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 20, query: $searchQuery) {\n      nodes {\n        id\n        handle\n        title\n        tags\n        productType\n        featuredImage {\n          id\n          url\n          altText\n          width\n          height\n        }\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        variants(first: 1) {\n          nodes {\n            id\n            availableForSale\n          }\n        }\n      }\n    }\n  }\n': {
    return: PackProductsQuery;
    variables: PackProductsQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
  ...
  '#graphql\n  query AnimaSiblings($searchQuery: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 10, query: $searchQuery) {\n      nodes {\n        title\n        handle\n        tags\n      }\n    }\n  }\n': {
    return: AnimaSiblingsQuery;
    variables: AnimaSiblingsQueryVariables;
  };
  '#graphql\n  query AnimaVariants($searchQuery: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 10, query: $searchQuery) {\n      nodes {\n        handle\n        collections(first: 5) {\n          nodes {\n            handle\n          }\n        }\n      }\n    }\n  }\n': {
    return: AnimaVariantsQuery;
    variables: AnimaVariantsQueryVariables;
  };
  ...
  '#graphql\n  fragment MoneyProductItem on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment ProductItem on Product {\n    id\n    handle\n    title\n    productType\n    tags\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        ...MoneyProductItem\n      }\n      maxVariantPrice {\n        ...MoneyProductItem\n      }\n    }\n    variants(first: 1) {\n      nodes {\n        id\n        availableForSale\n      }\n    }\n  }\n  query WishlistRecommendations($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 12, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...ProductItem\n      }\n    }\n  }\n': {
    return: WishlistRecommendationsQuery;
    variables: WishlistRecommendationsQueryVariables;
  };
}
