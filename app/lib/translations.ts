...
export const TRANSLATIONS = {
  IT: {
    ...
    pdp: {
      ...
      finish: 'Finish',
      aroma: 'Aroma',
      anatomiaDelProdotto: 'Anatomia del prodotto',
      packagingChiuso: 'Packaging chiuso',
      packagingAperto: 'Packaging aperto',
  ...
  EN: {
    ...
    pdp: {
      ...
      finish: 'Finish',
      aroma: 'Scent',
      anatomiaDelProdotto: 'Product anatomy',
      packagingChiuso: 'Closed packaging',
      packagingAperto: 'Open packaging',
  ...
  ES: {
    ...
    pdp: {
      ...
      finish: 'Acabado',
      aroma: 'Aroma',
      anatomiaDelProdotto: 'Anatomía del producto',
      packagingChiuso: 'Packaging cerrado',
      packagingAperto: 'Packaging abierto',
