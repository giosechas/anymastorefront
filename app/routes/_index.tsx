...
function Hero() {
  ...
  return (
    <section className="relative isolate flex min-h-[70vh] flex-col items-center justify-center overflow-hidden bg-nero px-6 py-20 text-center text-paper sm:min-h-[86vh] sm:py-6">
      ...
      <img src={logoWhite} alt="Anyma Beauty" className="mb-6 h-14 w-auto sm:h-16" />
      <h1 className="font-display max-w-4xl text-balance text-5xl italic leading-[1.05] tracking-[0.04em] text-fuchsia sm:text-6xl md:text-7xl">
        Reveal your Soul!
      </h1>
