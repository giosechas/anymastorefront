    ...
    <section aria-label={t('cart.discounts')}>
      ...
      <UpdateDiscountForm discountCodes={codes}>
        <div>
          ...
          />
          &nbsp;
          <button type="submit" aria-label={t('cart.applyDiscountCode')}>
            {t('cart.apply')}
          </button>
        </div>
      </UpdateDiscountForm>
      ...
      <AddGiftCardForm fetcherKey="gift-card-add">
        <div>
          ...
          <button
            ...
            aria-label={t('cart.applyGiftCardCode')}
          >
            {t('cart.apply')}
          </button>
        </div>
...
function RemoveGiftCardForm({
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        aria-label={t('cart.removeGiftCard', lastCharacters)}
